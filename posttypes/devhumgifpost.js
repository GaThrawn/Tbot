...
var contents = fs.readFileSync('./posttypes/devhumgifresults.json');
// Define to JSON type
...
function tweeted(err, data, response) {
    if (err) {
        console.log (userHandel + ' Something went wrong posting a DevHumor Gif Tweet!!!');
        var basictweet = require('./basictweet');
        basictweet.basictweet();
    } else {
        console.log (userHandel + ' has posted a DevHumor Gif Tweet!!!');
        
    };
   };  
  };
};
module.exports.devhumgifpost = devhumgifpost;